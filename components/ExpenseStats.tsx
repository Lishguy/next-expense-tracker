...
export default async function ExpenseStats() {
  ...
  const {
    ...
    daysWithRecords = 0,
    error: userError,
  } = userRecordResult as UserRecordResult;

  const {
    bestExpense,
    worstExpense,
    error: rangeError,
  } = rangeResult as ExpenseRangeResult;

  const error = userError || rangeError;
        ...
        <div className='flex items-center gap-3 mb-6'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
              Unable to load your expense data right now.
            </p>
          </div>
        </div>
